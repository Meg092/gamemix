...
class GameMixTextField extends StatefulWidget {
  final String value;
  ...
  @override
  createState() => _GameMixTextFieldState();
}

class _GameMixTextFieldState extends State<GameMixTextField> {
  ...
  @override
  void didUpdateWidget(GameMixTextField oldWidget) {
